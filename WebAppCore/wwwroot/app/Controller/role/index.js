    ...
    function registerEvents() {
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    structures.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    structures.stopLoading();
                },
                error: function () {
                    structures.notify('Has an error in save permission progress', 'error');
                    structures.stopLoading();
                }
            });
        });
    ...
    function loadFunctionList(callback) {
        ...
        return $.ajax({
            ...
            success: function (response) {
                ...
                //check cha thì tất cả thằng còn check theo
                ...
                $('.ckView').on('click', function () {
                    //nếu check tổng tất cả thằng còn bằng vs cha  thì check luôn thằng cha
